...
def main():
    ...
    parser.add_argument('--port', type=int, help='port distccd listens at', default=3632)
    parser.add_argument("ii", help="path to preprocessed source")
    parser.add_argument("ofile", help="output file path")
    parser.add_argument("compiler", nargs='*', help="compiler and arguments")
    args = parser.parse_args()

    dcc_compile(args.ii, args.compiler, ofile=args.ofile,
